			...
			<div class="container">
				...
				<div class="row">
					...
					<?php 
								...
								$sql = " SELECT * FROM products AS P,categories AS C
								 WHERE P.product_cat = C.cat_id  AND P.product_id = '$product_id'";
								if (!$con) {
							...
							<div class="col-md-5">
								...
								<h4 class="product-desc">'.$row['product_desc'].'</h4>
									...
									<div>
										<h3 class="product-price">Rs'.$row['product_price'].'<del class="product-old-price">Rs990.00</del></h3>
						...
						<div id="product-tab">
							...
							<ul class="tab-nav">
								...
								<?php
												...
												$product_query = "SELECT COUNT(*) AS count FROM reviews
					...
					<input id="star2" name="rating" value="2" type="radio" required><label for="star2"></label>
						...
						<a href="review.php"><button class="primary-btn" name="review_submit">Submit</button>
												</form>
											</div>
										</div>
										<!-- /Review Form -->
		...
		<div class="section main main-raised">
			...
			<div class="container">
				...
				<div class="row">
					...
					product_id BETWEEN $product_id AND $product_id+3";
                $run_query = mysqli_query($con,$product_query);
