...
?>
	...
	<th><a href="addsuppliers.php" class="btn btn-success">Add New</a></th>
                        ...
                        <td>$user_password</td>
                         <td>$mobile</td>
                          <td>$address1</td>
                           <td>$address2</td>";
                        echo"<td>
                        <a class='btn btn-sucess' href='edituser.php?user_id=$user_id&action=edit'>Edit<div class='ripple-container'></div></a>
              ...
              </div></div><div class="ps__rail-y" style="top: 0px; right: 0px;"><div 
              class="ps__thumb-y" tabindex="0" style="top: 0px; height: 0px;"></div></div></div>
              </div>
            </div>
          </div>
