...
if(isset($_POST["getProduct"])){
	...
	$product_query = "SELECT * FROM products,categories WHERE product_cat = '$cat_id'
	 AND product_cat=cat_id LIMIT $start,$limit";
                        ...
                        <div class='col-md-4 col-xs-6'>
								<a href='product.php?p=$pro_id'><div class='product'>
									...
									<div class='product-body'>
										...
										<del class='product-old-price'>Rs990.00</del></h4>
										<h5 class='product-desc header-cart-item-name'<a href='product.php?p=$pro_desc'>$pro_desc</a></h5>
										...
										echo "</div>
										<div class='product-btns'>
<button pid='' id='wishlist' class='add-to-wishlist' tabindex='0'><i class='fa fa-heart-o'>
</i><span class='tooltipp'>add to wishlist</span></button>
<button class='add-to-compare'><i class='fa fa-exchange'></i><span class='tooltipp'>add to compare</span></button>
	<button class='quick-view' ><i class='fa fa-eye'></i><span class='tooltipp'>quick view</span></button>
										</div>
									</div>
									<div class='add-to-cart'>
<button pid='$pro_id' id='product' href='#' tabindex='0' class='add-to-cart-btn'><i class='fa fa-shopping-cart'></i> 
add to cart</button>
									</div>
								</div>
							</div>
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span>$'
													.$product_price.'</h4>
													<h5 class="product_desc"><a href="#">'.$product_desc.'</a</h5>
