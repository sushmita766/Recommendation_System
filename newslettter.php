				...
				<div class="row">
					<div class="col-md-12">
						...
						<div class="newsletter">
							<p>Sign Up for the <strong>UPDATES</strong></p>
							...
							<ul class="newsletter-follow">
								<li>
									<a href="https://github.com/supportreddyhc"><i class="fa fa-facebook"></i></a>
								</li>
								<li>
									<a href="https://github.com/supportreddyhc"><i class="fa fa-twitter"></i></a>
								</li>
								<li>
									<a href="https://github.com/supportreddyhc"><i class="fa fa-instagram"></i></a>
								</li>
